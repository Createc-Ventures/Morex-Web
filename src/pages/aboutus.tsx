    ...
    <div className="bg-white w-full font-times">
      ...
      <section className="relative w-full h-[450px]">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
          <h1 className="font-bold text-[#cdb989] text-4xl md:text-5xl">ABOUT US</h1>
          <p className="mt-4 text-white text-base">-More Than Mortgages-</p>
        </div>
      </section>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-4 md:px-36 py-16 gap-10">
        ...
        <div className="w-full md:w-[591px] flex flex-col items-center text-center">
          <h2 className="text-[#012c51] font-bold text-3xl md:text-5xl mb-6">OUR JOURNEY</h2>
          ...
          <div className="mt-8">
            <h3 className="font-bold text-[#cdb989] text-xl mb-3">Want To Know More?</h3>
      ...
      <section className="relative py-16 flex flex-col items-center text-center px-4 md:px-0">
        ...
        <div className="max-w-lg z-10">
          <h2 className="text-[#cdb989] font-bold text-3xl md:text-5xl mb-6">OUR PURPOSE</h2>
          <p className="text-black text-sm md:text-base">
      ...
      <section className="py-16 px-4 md:px-12">
        <Card className="w-full max-w-[1032px] h-auto mx-auto bg-[url(public/assets/images/group.png)] bg-cover relative rounded-[30px]">
          ...
          <CardContent className="relative z-10 p-6 md:p-16 text-white">
            <h2 className="text-[#cdb989] font-bold text-3xl md:text-5xl mb-6">OUR GROUP</h2>
            <h3 className="font-bold mb-2">MOREX CAPITAL</h3>
            ...
            <Button className="bg-[#012c51] text-[#cdb989] rounded-[30px] text-base font-bold w-40 h-12">
              LEARN MORE
            </Button>
          </CardContent>
        </Card>
      ...
      <section className="w-full bg-neutral-100 py-16 px-4">
        <div className="flex flex-col md:flex-row gap-8 md:px-12">
          <div className="md:w-[328px]">
            <h2 className="text-[#012c51] font-bold text-3xl md:text-5xl">
            ...
            {partnerBenefits.map((benefit, index) => (
              <Card key={index} className="bg-[#cdb989] h-auto rounded-lg shadow-[-8px_8px_10px_#00000040]">
                <CardContent className="p-4">
                  <p className="text-[#012c51] font-bold text-center text-sm md:text-base">{benefit}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 px-4">
        <div className="text-center mb-12">
          <h2 className="text-[#012c51] font-bold text-3xl md:text-5xl mb-4">Our Team</h2>
          <p className="text-[#012c51] text-sm md:text-base max-w-2xl mx-auto">
          ...
          {teamMembers.map((member, index) => (
            <Card key={index} className="w-[90%] sm:w-[261px] bg-neutral-100 rounded-[30px_30px_30px_0px] shadow-[-8px_8px_10px_#00000040]">
              <CardContent className="flex flex-col items-center justify-center h-[124px] p-4">
                <h3 className="text-[#012c51] font-bold text-center text-sm">{member.name}</h3>
                <p className="text-[#cdb989] text-center mt-2 text-sm">{member.title}</p>
              </CardContent>
            </Card>
          ))}
        </div>
        <div className="flex justify-end pr-4 mt-6">
          <a href="/aboutus/team" className="text-[#012c51] font-bold underline text-sm">MORE DETAILS →</a>
        </div>
      </section>
